...
class Webservice {
    ...
    func getAllAccounts(token: String, completion: @escaping (Result<[Account], NetworkError>) -> Void) {
        ...
        guard let url = URL(string: "https://jealous-capricious-blackbird.glitch.me/accounts") else {
    ...
    func login(username: String, password: String, completion: @escaping (Result<String, AuthenticationError>) -> Void) {
        ...
        guard let url = URL(string: "https://jealous-capricious-blackbird.glitch.me/login") else {
